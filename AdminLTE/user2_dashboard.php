<?php
    $sql1 = "select * from richpig.raw_data where address = 2307 and board_number = 2 order by create_at desc limit 1";
...
<script>
    $(function () {
        ...
        function Get_Line_Chart_1_Data() {
            ...
            $.ajax({
                url: "../conf/user2_Ajax_Line_Chart_1.data.php",
                dataType: 'json',
        ...
        function Get_Line_Chart_2_Data() {
            $.ajaxSetup({ cache: false });
            $.ajax({
                url: "../conf/user2_Ajax_Line_Chart_2.data.php",
                dataType: 'json',
                success: function (data) {
