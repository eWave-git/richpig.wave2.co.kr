...
$query = "insert into richpig.raw_data_12ch (create_at, address, board_type, board_number, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12) values('".$get_time."','".$array_data[0]."','".$array_data[1]."','".$array_data[2]."','".$array_data[3]."','".$array_data[4]."','".$array_data[5]."','".$array_data[6]."','".$array_data[7]."','".$array_data[8]."','".$array_data[9]."','".$array_data[10]."','".$array_data[11]."','".$array_data[12]."','".$array_data[13]."','".$array_data[14]."')";

//$query = "insert into jstech.ro_jstech (create_at, board_ip, mb_id, tds_in, tds_out, pressure_in, pressure_out, water_in, water_out, current, level_origin, level_acid, level_alkali, level_cip, status_work) 
